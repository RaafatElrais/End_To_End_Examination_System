...
|-----------|----------------------|
| Database | SQL Server, Stored Procedures, ER Diagram |
...
💡 *This project demonstrates complete end-to-end system design — from database engineering and Python web development to analytics and reporting — built from scratch based on real business requirements and executed through effective teamwork and individual ownership.*
